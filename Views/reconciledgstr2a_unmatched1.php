...
<br>
    ...
    <label class="control control--radio">Unmatched of gstr2a
      <input type="radio" onclick="document.location='<?php echo base_url(); ?>index.php/Reconcilation/ReconcileGstr2aunmatched';" name="radiocus" checked/>
      <div class="control__indicator"></div>
    </label>
          ...
          <br> 
              ...
              <div class="form-group">
                ...
                <tbody>
                    ...
                    <?php } ?>
                    <?php for ($i = 0; $i < count($VendorDetails); ++$i) { ?>
                          <td><?php echo $gstlist1[$i]->VendorName; ?></td>
                     <?php } ?>
                        </tr>
                </tbody>
              </table>  
